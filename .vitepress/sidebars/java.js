export const java = [
  ...
  },
  {
    ...
    items: [
...

      {
        ...
        collapsed: true,
        items: [
          { test: 'Basic Classes', link: '/java/basic-classes' },
        ]
      }
    ]
  },

  {
    ...
    items: [
      ...
      { text: 'Private fields and methods', link: '/java/private-fields-and-properties' },
      { text: 'Static fields and methods', link: '/java/static-fields-and-methods' },
